...
Installera alla dependecises pip install -r requirements.txt
Alla börja klonade repon och skapade en branch med var o ch sitt namn.
Vi började arbeta i våra egna brancher och gjorde ändringar i filerna.
När vi var klara med våra ändringar så gjorde vi en git add . , git commit -m
sedag gjorde vi git push -u origin med vårt branch namn. 10 vi skapade en pull request på github repon.
...
Genom att skriva pyton -v *Python 3.11.9 när du skapar ditt virtual enviroment.
